...
train = MATDATA(path='/home/mike/data/wbc/classData06052014PythonMyeloidsOnlyTrain.mat', which_set = 'full', gcn = 55., 
		start=0, stop=1000, step=4)
...
test = MATDATA(path='/home/mike/data/wbc/classData06052014PythonMyeloidsOnlyTest.mat', which_set = 'full', gcn = 55., step=4)
